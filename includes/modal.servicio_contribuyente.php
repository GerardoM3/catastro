        ...
        <div class="modal-eliminar" >
            ...
            <div class="cuerpo-modal">
                ...
                <div style="display:inline-flex;">
                    ...
                    <div class="result" style="color:black;"><u>$rSC->id_servicio_alcaldia</u></div>
                </div>
                <br>
                <div style="display:inline-flex;">
                    <div class="desc">Servicio: </div>
                    <div class="result" style="color:black;"><u>$rSC->descripcion_servicio</u></div>
                </div>
            </div>
    ...
    <script>
        ...
        aceptar_eliminar_$i.addEventListener('click', ()=>{
                if(confirmar_$i.checked){
                    aceptar_eliminar_$i.setAttribute('href', `?c=Contribuyente&a=eliminarServicio&id_servicio_contribuyente=$rSC->id_servicio_contribuyente`);
                    modal_eliminar_$i.style.display = "none";
                    aceptar_eliminar_$i.disabled = true;
                    confirmar_$i.checked = false;
                }
