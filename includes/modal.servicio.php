        ...
        <div class="modal-eliminar" >
            ...
            <div class="cuerpo-modal">
                ...
                <div style="display:inline-flex;">
                    ...
                    <div class="result" style="color:black;"><u>$r->cod1-$r->cod2-$r->cod3-$r->cod4</u></div>
                </div>
                <br>
                <div style="display:inline-flex;">
                    <div class="desc">Servicio: </div>
                    <div class="result" style="color:black;"><u>$r->descripcion_servicio</u></div>
                </div>
            </div>
    ...
    <script>
        ...
        aceptar_eliminar_$i.addEventListener('click', ()=>{
                if(confirmar_$i.checked){
                    aceptar_eliminar_$i.setAttribute('href', `?c=Servicio&a=Eliminar&cod1=$r->cod1&cod2=$r->cod2&cod3=$r->cod3&cod4=$r->cod4`);
                    modal_eliminar_$i.style.display = "none";
                    aceptar_eliminar_$i.disabled = true;
                    confirmar_$i.checked = false;
                }
